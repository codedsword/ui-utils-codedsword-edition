...
import java.util.Vector;
    ...
    public class MainClient implements ClientModInitializer {
        ...
        public static void createWidgets(MinecraftClient mc, Screen screen) {
            ...
            screen.addDrawableChild(ButtonWidget.builder(Text.of("stop before finishing"), (button) -> {
            ...
            screen.addDrawableChild(ButtonWidget.builder(Text.of("bait the server to think u have finished"), (button) -> {
            ...
            screen.addDrawableChild(ButtonWidget.builder(Text.of("Send nudes: " + SharedVariables.sendUIPackets), (button) -> {
            ...
            screen.addDrawableChild(ButtonWidget.builder(Text.of("Delay cumming: " + SharedVariables.delayUIPackets), (button) -> {
            ...
            screen.addDrawableChild(ButtonWidget.builder(Text.of("Save the porn vid"), (button) -> {
            ...
            screen.addDrawableChild(ButtonWidget.builder(Text.of("finish and noclip into the backrooms"), (button) -> {
                ...
                if (mc.getNetworkHandler() != null) {
                    ...
                    mc.getNetworkHandler().getConnection().disconnect(Text.of("You have nutted all over ur monitor"));
                } else {
            ...
            ButtonWidget fabricatePacketButton = ButtonWidget.builder(Text.of("catfish the server frfr"), (button) -> {
                ...
                clickSlotButton.addActionListener((event) -> {
                    ...
                    sendButton.addActionListener((event0) -> {
                        if (
                                com.ui_utils.MainClient.isInteger(syncIdField.getText()) &&
                                        com.ui_utils.MainClient.isInteger(revisionField.getText()) &&
                                        com.ui_utils.MainClient.isInteger(slotField.getText()) &&
                                        com.ui_utils.MainClient.isInteger(buttonField.getText()) &&
                                        com.ui_utils.MainClient.isInteger(timesToSendField.getText()) &&
                            ...
                            SlotActionType action = com.ui_utils.MainClient.stringToSlotActionType(actionField.getSelectedItem().toString());
                            ...
                            if (action != null) {
                                ...
                                try {
                                    ...
                                    com.ui_utils.MainClient.queueTask(() -> {
                                        statusLabel.setVisible(false);
                                        statusLabel.setText("");
                                    }, 1500L);
                                    return;
                ...
                buttonClickButton.addActionListener((event) -> {
                    ...
                    sendButton.addActionListener((event0) -> {
                        if (
                                com.ui_utils.MainClient.isInteger(syncIdField.getText()) &&
                                        com.ui_utils.MainClient.isInteger(buttonIdField.getText()) &&
                                        com.ui_utils.MainClient.isInteger(timesToSendField.getText())) {
                            int syncId = Integer.parseInt(syncIdField.getText());
